...
data = importdata('Madrid_Speed_SurfaceAirTemp.xlsx');   % Import data
...
normalized_sat = (((data(:,2))-satMEAN)/satSTD);
...
for i = 1:(dataSize(1)-(numOfInputs/2))  
    ...
    netData(i,((numOfInputs/2)+1):numOfInputs) = normalized_sat(i:(i+((numOfInputs/2)-1)))';
