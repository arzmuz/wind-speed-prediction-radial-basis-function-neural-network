...
normFactor = 30;
normalized_data = data/normFactor;   % Normalized: 0 to 1
...
training_actualOutput(j,1) = training_actualOutput(j,1)*normFactor;
training_expectedOutput(j,1) = training_expectedOutput(j,1)*normFactor;
...
% Denormalization of expected and predicted values
testing_actualOutput(k,1) = testing_actualOutput(k,1)*normFactor;
testing_expectedOutput(k,1) = testing_expectedOutput(k,1)*normFactor;
